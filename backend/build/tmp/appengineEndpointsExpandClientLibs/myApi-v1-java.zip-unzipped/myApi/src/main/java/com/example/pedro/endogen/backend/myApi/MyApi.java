 ...
 * on 2015-06-26 at 05:08:51 UTC 
 * Modify at your own risk.
 */

package com.example.pedro.endogen.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "createMapMarker".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link CreateMapMarker#execute()} method to invoke the remote operation.
   *
   * @param data
   * @return the request
   */
  public CreateMapMarker createMapMarker(java.lang.String data) throws java.io.IOException {
    CreateMapMarker result = new CreateMapMarker(data);
    initialize(result);
    return result;
  }

  public class CreateMapMarker extends MyApiRequest<com.example.pedro.endogen.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "createMapMarker/{data}";
     ...
     * parameters, call the {@link CreateMapMarker#execute()} method to invoke the remote operation.
     * <p> {@link CreateMapMarker#initialize(com.google.api.client.googleapis.services.AbstractGoogleC
     ...
     * @since 1.13
     */
    protected CreateMapMarker(java.lang.String data) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.pedro.endogen.backend.myApi.model.MyBean.class);
      this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
    }

    @Override
    public CreateMapMarker setAlt(java.lang.String alt) {
      return (CreateMapMarker) super.setAlt(alt);
    }

    @Override
    public CreateMapMarker setFields(java.lang.String fields) {
      return (CreateMapMarker) super.setFields(fields);
    }

    @Override
    public CreateMapMarker setKey(java.lang.String key) {
      return (CreateMapMarker) super.setKey(key);
    }

    @Override
    public CreateMapMarker setOauthToken(java.lang.String oauthToken) {
      return (CreateMapMarker) super.setOauthToken(oauthToken);
    }

    @Override
    public CreateMapMarker setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (CreateMapMarker) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public CreateMapMarker setQuotaUser(java.lang.String quotaUser) {
      return (CreateMapMarker) super.setQuotaUser(quotaUser);
    }

    @Override
    public CreateMapMarker setUserIp(java.lang.String userIp) {
      return (CreateMapMarker) super.setUserIp(userIp);
    }
    ...
    public CreateMapMarker setData(java.lang.String data) {
      this.data = data;
      return this;
    }

    @Override
    public CreateMapMarker set(String parameterName, Object value) {
      return (CreateMapMarker) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.pedro.endogen.backend.myApi.model.MyBean> {
