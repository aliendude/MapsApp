...
public class CreateMarkerActivity extends ActionBarActivity implements CreateMarkerFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.create_marker_content, new CreateMarkerFragment());
        transaction.commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_create_marker, menu);
        return true;
    }
